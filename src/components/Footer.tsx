  ...
  return (
    <footer>
      <div className="relative">
        <div
          className="rounded-xl bg-white shadow-lg py-10 px-6 md:px-12 flex flex-col md:flex-row justify-between items-start gap-10 md:gap-0"
          style={{ marginBottom: "-48px", zIndex: 10, position: "relative" }}
        >
        ...
        <div
          className="flex justify-center md:justify-end gap-4 pt-8 pb-2"
