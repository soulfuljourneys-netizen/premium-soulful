          ...
          <>
            <div className="mt-8 bg-white rounded-xl shadow p-6 border border-gray-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 text-gray-700">
                <div>
                  <span className="font-medium">Trip:</span> {state.trip}
                </div>
                <div>
                ...
                <div>
                  <span className="font-medium">Phone:</span> {state.phone}
                </div>
                <div>
                  <span className="font-medium">City:</span> {state.city}
                </div>
                <div>
                  <span className="font-medium">Room:</span> {state.room}
                </div>
                <div>
                  <span className="font-medium">Date:</span> {state.date}
                </div>
                <div>
                  <span className="font-medium">Seats:</span> {state.seats}
                </div>
                <div>
            ...
            <div className="mt-8 bg-white rounded-xl shadow p-6 border border-gray-100">
              ...
              <div className="text-gray-800 space-y-2">
                ...
                <div>
                  <span className="font-medium">Account Name:</span> Soulful
                  Journeys
                </div>
                <div>
                ...
                <div>
                  <span className="font-medium">IFSC Code:</span> HDFC0001234
                </div>
                <div>
                  <span className="font-medium">Branch:</span> Connaught Place,
                  New Delhi
                </div>
              </div>
              <div className="text-xs text-gray-500 mt-2">
                (You can pay via UPI or direct bank transfer. After payment,
                upload your screenshot and transaction number below.)
              </div>
            </div>
